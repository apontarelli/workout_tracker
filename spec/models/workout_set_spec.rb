...
RSpec.describe WorkoutSet do
  ...
  let(:workout) { Workout.create!(user:, name: 'Morning Workout') }
  let(:exercise) { Exercise.create!(name: 'Push Up') }
  let(:workout_exercise) { WorkoutExercise.create!(workout:, exercisable: exercise) }
