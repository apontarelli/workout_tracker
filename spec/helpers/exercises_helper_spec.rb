...
RSpec.describe ExercisesHelper, type: :helper do
  ...
  before do
    ...
    @global_exercise = Exercise.create!(name: 'Push Up', instructions: 'A basic push-up exercise', primary_muscle_group: 'Chest', secondary_muscle_groups: ['Triceps'], equipment: 'None', exercise_group: 'Strength')
    @user_exercise = UserExercise.create!(name: 'User Exercise', primary_muscle_group: 'Legs', secondary_muscle_groups: ['Glutes'], equipment: 'Dumbbells', exercise_group: 'Strength', user: user)
  end
